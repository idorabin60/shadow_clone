...
function MiniNavbar() {
    ...
    const loginButtonElement = (
        <Link href="/login" className="px-4 text-center py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto">
            LogIn
        </Link>
    );
    ...
    const signupButtonElement = (
        <div className="relative group w-full sm:w-auto">
            ...
            <Link href="/signup" className="relative z-10 block text-center px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto">
                Signup
            </Link>
        </div>
    );
...
export const SignInPage = ({ className, type = "login" }: SignInPageProps) => {
                                ...
                                {step === "email" ? (
                                    ...
                                    >
                                        <div className="space-y-1">
                                            <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">{isLogin ? "Welcome Back" : "Welcome Developer"}</h1>
                                            <p className="text-[1.8rem] text-white/70 font-light">{isLogin ? "Sign in to your account" : "Your sign up component"}</p>
                                        </div>
