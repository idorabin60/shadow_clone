  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gray-100 flex flex-row items-center p-8">
        <div className="w-1/2">
          <img src="/path/to/image.jpg" alt="About Us" className="w-full h-auto" />
        </div>
        <div className="w-1/2 text-gray-900">
          <p>המוסך הכי טוב במדינה מספק שירות 24/7 לכל בעיה</p>
        </div>
      </section>

      {/* Services Section */}
      <section className="bg-white grid grid-cols-1 md:grid-cols-2 gap-4 p-8 text-gray-900">
        <h2 className="text-3xl font-bold col-span-full">השירותים שלנו</h2>
        <div className="flex items-center">
          <span className="material-icons text-yellow-500 mr-2">build</span>
          <p>מתנקים כל דבר אפשרי ברכב</p>
        </div>
      ...
      <section className="bg-blue-800 flex flex-col items-center justify-center p-8 text-white">
        <h2 className="text-3xl font-bold mb-4">צרו קשר עכשיו לקבלת שירות מקצועי</h2>
