    ...
    def generate(self, query: str, project_name: str = None) -> dict:
        ...
        return {
            ...
            "style": {
                ...
                "ai_prompt_keywords": best_style.get("AI Prompt Keywords", ""),
                "css_technical_keywords": best_style.get("CSS/Technical Keywords", ""),
                "implementation_checklist": best_style.get("Implementation Checklist", ""),
                "design_system_variables": best_style.get("Design System Variables", "")
            },
            "colors": {
