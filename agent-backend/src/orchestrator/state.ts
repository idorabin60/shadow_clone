...
import type { CostTracker } from "../lib/logger";
...
export interface OrchestrationState {
    ...
    /** Design system recommendation generated by PM node, consumed by Developer and QA. */
    designSystem: DesignSystemRecommendation | null;

    /** Accumulated cost tracker across all nodes in this run. */
