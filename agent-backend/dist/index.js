    ...
    try {
        ...
        (async () => {
            ...
            try {
                ...
                const viteProcess = (0, child_process_1.spawn)("npm", ["run", "dev", "--", "--port", port.toString(), "--strictPort", "--host", "--base", `/serve/${sandboxId}/`], {
                    cwd: sandboxPath,
                    shell: true
                });
...
app.use("/serve/:uuid", (req, res, next) => {
    ...
    (0, express_http_proxy_1.default)(`http://localhost:${serverInfo.port}`, {
